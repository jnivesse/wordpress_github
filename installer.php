...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20231115_animalin_e27f498113f104ea3473_20231115132413_archive.zip';
        const ARCHIVE_SIZE       = '84016480';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'e27f498-15132413';
        const SECONDARY_PACKAGE_HASH = '93f22fc-15132413';
        const VERSION            = '1.5.7';
